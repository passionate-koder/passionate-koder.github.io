  ...
  head: () => ({
    meta: [
      { title: "IdeaSpark — Online Ideathon by HackerRank Campus Crew, IIT Madras" },
      {
        name: "description",
        content:
          "IdeaSpark: an online Ideathon hosted by the HackerRank Campus Crew at IIT Madras. Build ideas that solve real-world problems.",
      },
      { property: "og:title", content: "IdeaSpark — IIT Madras Ideathon" },
      {
        property: "og:description",
        content: "Online Ideathon by HackerRank Campus Crew, IIT Madras.",
      },
    ],
  }),
  component: Index,
  ...
  return (
    <nav className="sticky top-0 z-50 bg-cream/90 backdrop-blur border-b border-ink/15">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 sm:py-6 flex items-center justify-between font-sans-ui gap-4">
        <a
          href="#top"
          className="flex items-center gap-2.5 font-display text-2xl sm:text-3xl tracking-tight"
        >
        ...
        <div className="hidden md:flex gap-10 text-base sm:text-lg uppercase tracking-widest font-medium">
          {links.map(([h, l]) => (
            <a key={h} href={h} className="hover:text-saffron transition-colors">
              {l}
            </a>
          ))}
        </div>
          ...
          <div className="flex flex-col px-4 py-6 gap-2 font-sans-ui uppercase tracking-widest text-base">
            {links.map(([h, l]) => (
              <a
                ...
                className="py-3 border-b border-ink/10"
              >
                {l}
              </a>
            ))}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-10 pb-8 md:pt-24 md:pb-16">
        <div className="grid md:grid-cols-12 gap-6 items-end">
          ...
          <div className="md:col-span-3 md:pb-6">
            <p className="font-serif italic text-lg sm:text-xl md:text-2xl leading-snug">
              Build ideas that solve{" "}
              <span className="underline decoration-saffron decoration-4 underline-offset-4">
                real-world
              </span>{" "}
              problems.
            </p>
        ...
        <div className="grid md:grid-cols-12 gap-8 md:gap-10">
          <div className="md:col-span-5 font-serif text-lg sm:text-xl md:text-2xl leading-relaxed">
            An Ideathon for the curious, the relentless, and the quietly ambitious. Pitch the idea
            you can&apos;t stop thinking about — and let it find its sparring partners.
          </div>
          <div className="md:col-span-4 font-sans-ui">
            ...
            <div className="text-xs uppercase tracking-widest text-muted-foreground mt-4 sm:mt-6 mb-2">
              Where
            </div>
    ...
    <section id="about" className="max-w-7xl mx-auto px-4 sm:px-6 py-16 md:py-24">
      <div className="grid md:grid-cols-12 gap-8 md:gap-10">
        <div className="md:col-span-4">
          <div className="font-sans-ui text-xs uppercase tracking-[0.25em] text-saffron mb-4">
            § 01 · About
          </div>
          <h2 className="font-display text-5xl sm:text-6xl md:text-8xl text-ink">
            What&apos;s an
            <br />
            Ideathon?
          </h2>
        ...
        <div className="md:col-span-7 md:col-start-6 font-serif text-lg sm:text-xl md:text-2xl leading-relaxed space-y-5">
          <p>
            Not a hackathon. Not a pitch competition. An <em>Ideathon</em> is the space between —
            where the idea matters more than the polish, and the argument for it matters most of
            all.
          </p>
          <p>
            Over a single online weekend, you&apos;ll respond to a problem statement, sketch a
            solution, and submit a focused pitch. No frameworks worship. No demo theatre. Just clear
            thinking, shipped on time.
          </p>
...
const STEPS = [
  {
    n: "01",
    t: "Register & Pitch",
    d: "Sign up with your team, choose your theme, and submit a concise concept pitch deck.",
  },
  {
    n: "02",
    t: "Shortlist",
    d: "Judges review pitch decks. Only the top selected ideas advance to the building phase.",
  },
  {
    n: "03",
    t: "Build & Demo",
    d: "Shortlisted teams build working prototypes and submit a 3-minute video demo.",
  },
  {
    n: "04",
    t: "Final Results",
    d: "Expert panel evaluates the final prototypes. Winners and certificates announced live.",
  },
];
    ...
    <section id="how" className="bg-ink text-cream grain">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16 md:py-24">
        <div className="flex items-end justify-between mb-10 md:mb-16 flex-wrap gap-6">
          <div>
            <div className="font-sans-ui text-xs uppercase tracking-[0.25em] text-amber mb-4">
              § 02 · How it works
            </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-px bg-cream/20 border border-cream/20">
          {STEPS.map((s) => (
            <div
              key={s.n}
              className="bg-ink p-6 sm:p-8 flex flex-col gap-4 sm:gap-6 min-h-[220px] sm:min-h-[280px]"
            >
              <div className="font-display text-[5rem] sm:text-[7rem] leading-none text-amber">
                {s.n}
              </div>
              <div>
                ...
                <p className="font-serif mt-3 opacity-80 leading-relaxed text-base sm:text-lg">
                  {s.d}
                </p>
              </div>
            </div>
...
const THEMES = [
  {
    title: "AI & Automation",
    desc: "Build intelligent systems, agentic workflows, and automated solutions to unlock new possibilities.",
  },
  {
    title: "Sustainability",
    desc: "Create ideas that address climate change, renewable energy, eco-friendly tech, or waste management.",
  },
  {
    title: "Healthcare",
    desc: "Design systems for remote patient care, diagnostic intelligence, medical accessibility, or wellness tracking.",
  },
  {
    title: "FinTech",
    desc: "Reimagine personal finance, decentralized ledgers, secure payments, or automated wealth management.",
  },
  {
    title: "Smart India",
    desc: "Solve unique localized challenges for rural development, urban transit, and public administration.",
  },
  {
    title: "Accessibility",
    desc: "Ensure digital and physical spaces are fully inclusive for individuals with diverse physical abilities.",
  },
  {
    title: "Open Innovation",
    desc: "Have a brilliant concept that breaks traditional domain barriers? Pitch your wild card idea here.",
  },
];
...
function Themes() {
  return (
    <section
      id="themes"
      className="max-w-7xl mx-auto px-4 sm:px-6 py-16 md:py-24 border-t border-ink/15"
    >
      <div className="grid md:grid-cols-12 gap-8 md:gap-10">
        <div className="md:col-span-4">
          <div className="font-sans-ui text-xs uppercase tracking-[0.25em] text-saffron mb-4">
        ...
        <div className="md:col-span-8">
          <div className="grid sm:grid-cols-2 gap-6">
            {THEMES.map((t) => (
              <div
                key={t.title}
                className="bg-cream border border-ink/20 p-6 sm:p-8 flex flex-col gap-3 hover:border-saffron hover:-translate-y-1 transition-all duration-300"
              >
                <div className="font-display text-2xl sm:text-3xl uppercase tracking-wider text-saffron">
                  {t.title}
                </div>
        ...
        <div className="grid md:grid-cols-12 gap-8 md:gap-10 items-center">
          <div className="md:col-span-7">
            ...
            <p className="font-serif text-lg sm:text-xl md:text-2xl leading-relaxed mt-6 text-muted-foreground">
              Registering on HackerRank is only half the battle. To officially secure your
              team&apos;s spot and select your theme, you{" "}
              <strong className="text-ink underline decoration-saffron decoration-4 underline-offset-2">
                must
              </strong>{" "}
              fill out the Google Confirmation Form. Unconfirmed teams will not be evaluated.
            </p>
          </div>
          <div className="md:col-span-5 flex flex-col gap-4">
            <div className="bg-cream border border-ink p-6 sm:p-8 flex flex-col gap-4 btn-tactile">
              <div className="font-sans-ui text-xs uppercase tracking-widest text-muted-foreground">
                Verification Form
              </div>
              <div className="font-display text-2xl sm:text-3xl uppercase tracking-wider text-ink">
                Google Form
              </div>
...
function Timeline() {
  return (
    <section id="timeline" className="max-w-7xl mx-auto px-4 sm:px-6 py-16 md:py-24">
      ...
      <h2 className="font-display text-5xl sm:text-6xl md:text-8xl mb-10 md:mb-16">
        Key dates,
        <br />
        <span className="italic font-serif font-normal text-forest">in order.</span>
      </h2>
      <ol className="divide-y divide-ink/30 border-y border-ink/30">
        {TIMELINE.map((t, i) => (
          <li
            key={i}
            className="grid grid-cols-12 gap-3 sm:gap-6 py-6 sm:py-8 items-baseline group"
          >
...
const PRIZES = [
  {
    ...
    rank: "1st Place",
    color: "text-gold",
    note: "Gold Certificate · HackerRank feature",
  },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16 md:py-24">
        <div className="grid md:grid-cols-12 gap-6 md:gap-10 items-end mb-10 md:mb-16">
          ...
          <p className="md:col-span-5 font-serif italic text-lg sm:text-xl md:text-2xl opacity-90">
            Every participant receives a verified Participation Certificate from the HackerRank
            Campus Crew, IIT Madras. Tiered honours for the top three.
          </p>
        </div>
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6">
          {PRIZES.map((p, i) => (
            <div
              key={p.tier}
              className={`bg-cream text-ink p-6 sm:p-8 border border-ink/20 ${i === 0 ? "md:-translate-y-6" : ""}`}
            >
              <div className={`font-display text-6xl sm:text-7xl md:text-8xl ${p.color}`}>
                {p.tier}
              </div>
              <div className="rule my-4 sm:my-6 bg-ink" />
              <div className="font-display text-xl sm:text-2xl uppercase tracking-wider">
                {p.rank}
              </div>
...
const FAQS = [
  {
    ...
    a: "Open to students with a valid college ID. IIT Madras students get priority access.",
  },
  { q: "Solo or team?", a: "Solo entries are welcome; teams may have up to four members." },
  {
    q: "Is there a registration fee?",
    a: "No. IdeaSpark is free to enter. You just need a HackerRank account.",
  },
  {
    q: "What do I submit?",
    a: "A pitch deck (PDF, max 8 slides) and a 3-minute walkthrough video pitch link. You will be judged by the video pitch",
  },
  {
    q: "How are submissions judged?",
    a: "On clarity of problem, originality of idea, feasibility, and quality of pitch — in that order.",
  },
];
            ...
            {FAQS.map((f, i) => {
              ...
              return (
                <li key={i} className="border-b border-ink/30">
                  ...
                  >
                    <span className="font-display text-xl sm:text-2xl md:text-3xl uppercase tracking-wider">
                      {f.q}
                    </span>
                    <span className="font-display text-2xl sm:text-3xl text-saffron shrink-0">
                      {isOpen ? "−" : "+"}
                    </span>
                  </button>
                  <div
  ...
  return (
    <section className="bg-saffron text-cream grain">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16 md:py-24 text-center">
        <h2 className="font-display text-5xl sm:text-6xl md:text-7xl lg:text-8xl leading-[0.9]">
          Bring the idea.
          <br />
          <span className="italic font-serif font-normal">We&apos;ll bring the room.</span>
        </h2>
        <a
          href={HACKERRANK_URL}
          target="_blank"
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-12 gap-8 md:gap-10">
          <div className="md:col-span-5">
            ...
            <p className="font-serif italic mt-4 opacity-80 max-w-sm text-base sm:text-lg">
              An online Ideathon by the HackerRank Campus Crew at IIT Madras, BS in Data Science and
              Applications.
            </p>
          </div>
          <div className="md:col-span-3 font-sans-ui text-sm">
            <a
              href="https://linkedin.com/in/shankhabuilds"
              target="_blank"
              rel="noreferrer"
              className="text-xs uppercase tracking-widest opacity-60 mb-3 hover:text-amber block"
            >
              Contact
            </a>
          </div>
          <div className="md:col-span-4 font-sans-ui text-sm">
            ...
            <div className="flex flex-wrap gap-4 sm:gap-6">
              <a href="[INSTAGRAM HANDLE]" className="hover:text-amber">
                Instagram
              </a>
              <a
                href="https://www.linkedin.com/company/hackerrank-campus-crew-iitm/"
                target="_blank"
                rel="noreferrer"
              ...
              <a href={HACKERRANK_URL} className="hover:text-amber">
                HackerRank
              </a>
            </div>
          </div>
